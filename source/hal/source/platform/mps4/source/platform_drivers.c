...
static const struct hdlcd_dev_cfg_t HDLCD_DEV_CFG_S = {
    .base        = HDLCD_BASE_S,
    .polarities  = (POLARITIES_DATA_POLARITY_Msk | POLARITIES_DATAEN_POLARITY_Msk |
...
static struct hdlcd_dev_t HDLCD_DEV_S = {&(HDLCD_DEV_CFG_S), &(HDLCD_DEV_DATA_S)};

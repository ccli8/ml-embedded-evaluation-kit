...
To use the other supported memory modes refer to [vela.ini](https://gitlab.arm.com/artificial-intelligence/ethos-u/ethos-u-vela/-/blob/5.1.0/ethosu/config_files/Arm/vela.ini).
